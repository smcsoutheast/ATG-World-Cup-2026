...
Super Admin score entry now supports score statuses.

Group Stage statuses:
1. Kickoff
2. Halftime
3. Final

Knockout Stage statuses:
1. Kickoff
2. Halftime
3. Extra Time
4. Penalties
...
Only Final scores count toward:
- Around the Grounds standings
- Awards
